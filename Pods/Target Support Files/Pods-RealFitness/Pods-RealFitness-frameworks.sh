...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FNReactionsView/FNReactionsView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/LGPlusButtonsView/LGPlusButtonsView.framework"
