...
public extension SCNNode {
    convenience init(withJSON profile: JSON, position: SCNVector3) {
        ...
        material.diffuse.contents = UIImage.init(named: "heart.png")
        ...
        twitterMaterial.diffuse.contents = UIImage.init(named: "steps.png")
        ...
        fbMaterial.diffuse.contents = UIImage.init(named: "distance.png")
